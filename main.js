...
function recoverData() {
    ...
    applOwn.innerHTML = localStorage.getItem("applOwn")
    applPrice.innerHTML = localStorage.getItem("applPrice")
    cocoOwn.innerHTML = localStorage.getItem("cocoOwn")
    cocoPrice.innerHTML = localStorage.getItem("cocoPrice")
    bioOwn.innerHTML = localStorage.getItem("bioOwn")
    bioPrice.innerHTML = localStorage.getItem("bioPrice")
    starOwn.innerHTML = localStorage.getItem("starOwn")
    starPrice.innerHTML = localStorage.getItem("starPrice")
    rainOwn.innerHTML = localStorage.getItem("rainOwn")
    rainPrice.innerHTML = localStorage.getItem("rainPrice")
    chicUppOwn.innerHTML = localStorage.getItem("chicUppOwn")
    chicUppPrice.innerHTML = localStorage.getItem("chicUppPrice")
    grainUppOwn.innerHTML = localStorage.getItem("grainUppOwn")
    grainUppPrice.innerHTML = localStorage.getItem("grainUppPrice")
    milkUppOwn.innerHTML = localStorage.getItem("milkUppOwn")
    milkUppPrice.innerHTML = localStorage.getItem("milkUppPrice")
    riceUppOwn.innerHTML = localStorage.getItem("riceUppOwn")
    riceUppPrice.innerHTML = localStorage.getItem("riceUppPrice")
    tomatoUppOwn.innerHTML = localStorage.getItem("tomatoUppOwn")
    tomatoUppPrice.innerHTML = localStorage.getItem("tomatoUppPrice")
    rasUppOwn.innerHTML = localStorage.getItem("rasUppOwn")
    rasUppPrice.innerHTML = localStorage.getItem("rasUppPrice")
    peachUppOwn.innerHTML = localStorage.getItem("peachUppOwn")
    peachUppPrice.innerHTML = localStorage.getItem("peachUppPrice")
    applUppOwn.innerHTML = localStorage.getItem("applUppOwn")
    applUppPrice.innerHTML = localStorage.getItem("applUppPrice")
    cocoUppOwn.innerHTML = localStorage.getItem("cocoUppOwn")
    cocoUppPrice.innerHTML = localStorage.getItem("cocoUppPrice")
    bioUppOwn.innerHTML = localStorage.getItem("bioUppOwn")
    bioUppPrice.innerHTML = localStorage.getItem("bioUppPrice")
    starUppOwn.innerHTML = localStorage.getItem("starUppOwn")
    starUppPrice.innerHTML = localStorage.getItem("starUppPrice")
...
function saveData() {
    ...
    localStorage.setItem("applOwn",applOwn.innerHTML)
    localStorage.setItem("applPrice",applPrice.innerHTML)
    localStorage.setItem("cocoOwn",cocoOwn.innerHTML)
    localStorage.setItem("cocoPrice",cocoPrice.innerHTML)
    localStorage.setItem("bioOwn",bioOwn.innerHTML)
    localStorage.setItem("bioPrice",bioPrice.innerHTML)
    localStorage.setItem("starOwn",starOwn.innerHTML)
    localStorage.setItem("starPrice",starPrice.innerHTML)
    localStorage.setItem("rainOwn",rainOwn.innerHTML)
    ...
    localStorage.setItem("grainUppOwn",grainUppOwn.innerHTML)
    localStorage.setItem("grainUppPrice",grainUppPrice.innerHTML)
    localStorage.setItem("milkUppOwn",milkUppOwn.innerHTML)
    localStorage.setItem("milkUppPrice",milkUppPrice.innerHTML)
    localStorage.setItem("riceUppOwn",riceUppOwn.innerHTML)
    localStorage.setItem("riceUppPrice",riceUppPrice.innerHTML)
    localStorage.setItem("tomatoUppOwn",tomatoUppOwn.innerHTML)
    localStorage.setItem("tomatoUppPrice",tomatoUppPrice.innerHTML)
    localStorage.setItem("rasUppOwn",rasUppOwn.innerHTML)
    localStorage.setItem("rasUppPrice",rasUppPrice.innerHTML)
    localStorage.setItem("peachUppOwn",peachUppOwn.innerHTML)
    localStorage.setItem("peachUppPrice",peachUppPrice.innerHTML)
    localStorage.setItem("applUppOwn",applUppOwn.innerHTML)
    localStorage.setItem("applUppPrice",applUppPrice.innerHTML)
    localStorage.setItem("cocoUppOwn",cocoUppOwn.innerHTML)
    localStorage.setItem("cocoUppPrice",cocoUppPrice.innerHTML)
    localStorage.setItem("bioUppOwn",bioUppOwn.innerHTML)
    localStorage.setItem("bioUppPrice",bioUppPrice.innerHTML)
    localStorage.setItem("starUppOwn",starUppOwn.innerHTML)
    localStorage.setItem("starUppPrice",starUppPrice.innerHTML)
    localStorage.setItem("rainUppOwn",rainUppOwn.innerHTML)
    localStorage.setItem("rainUppPrice",rainUppPrice.innerHTML)
    console.log("SAVED!")
}
